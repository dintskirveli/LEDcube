...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Tue Feb 11 19:55:26 2014
# Project:  LEDcube.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.8/mkspecs/macx-g++ -o Makefile LEDcube.pro
#############################################################################
...
Makefile: LEDcube.pro  /usr/local/Qt4.8/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
		/usr/local/Qt4.8/mkspecs/common/mac.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Qt4.8/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-g++ -o Makefile LEDcube.pro
...
LEDcube.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,LEDcube,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.8/mkspecs/macx-g++/Info.plist.app >LEDcube.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/LEDcube1.0.0 || $(MKDIR) .tmp/LEDcube1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LEDcube1.0.0/ && $(COPY_FILE) --parents glwidget.h window.h .tmp/LEDcube1.0.0/ && $(COPY_FILE) --parents glwidget.cpp main.cpp window.cpp .tmp/LEDcube1.0.0/ && (cd `dirname .tmp/LEDcube1.0.0` && $(TAR) LEDcube1.0.0.tar LEDcube1.0.0 && $(COMPRESS) LEDcube1.0.0.tar) && $(MOVE) `dirname .tmp/LEDcube1.0.0`/LEDcube1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LEDcube1.0.0
